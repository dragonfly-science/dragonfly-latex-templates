% This is the document class for MPI FARs. Note that this format is interchangable with
% report. Any MPI FAR will compile as a dragonfly-report and vice versa.
% The draft option will also work. 
\documentclass{mpi-far}

% The MPI FAR requires two titles. The first is the short title which goes on the 
...
% Generate the table of contents. This should be done for MPI FARs.
\tableofcontents

% An MPI FAR must contain an executive summary. Which \summary will generate a 
